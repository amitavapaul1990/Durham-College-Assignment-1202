...
## Description
In this Document, we will learn how to use Python for preprocessing your data when Imported from a csv file. By the end of this document, you will be familiar with basic python function for building baisc statistical analysis for your dataset.
## Getting started
### Prerequisites
